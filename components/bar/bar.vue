<template>
	<view>
		<view class="header" :style="{'height':titleBarHeight,'padding-top':statusBarHeight}">
			...
			<view class="goal-container   animated fadeInDown delay-1s"  v-if="nav.isShowGoal" @tap="jumpToGoal()">
				<image class="iconimg icon-goal" :style="{'width':iconimg,'height':iconimg}" src="../../static/icon/goal.png"></image>
				<!-- 目标 -->
			</view>
			<view class="setting-container   animated fadeInDown delay-013s"  v-if="nav.isShowSetting"  @tap="jumpToSetting()">
